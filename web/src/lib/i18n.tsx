...
const en: Dict = {
  ...
  "perm.globalIntro": "What an agent may do when no per-agent override or trust tier decides. 'Ask' routes to you for approval.",
  "perm.cap.contact_agent": "Contact agents",
  "perm.cap.contact_agent.desc": "Message another agent. In-scope targets follow the trust tier; out-of-scope ones need an explicit grant.",
  ...
  "perm.tierHeading": "What each trust tier grants",
  "perm.tierIntro": "Trust tiers are named permission presets. A higher tier loosens what the agent may do without asking you.",
  "perm.tierCol": "Tier",
  "perm.inheritShort": "default",
  "perm.tierNote": "Most specific wins: per-pair grant > per-agent override > trust tier > global default. Contact also has a master switch above.",
  "perm.override.default": "Default",
  "perm.override.note": "The chip shows the effect in force for this agent. Override pins one capability for this agent only; Default follows the tier.",
...
const zh: Dict = {
  ...
  "perm.globalIntro": "当没有单独覆盖、也没有信任档位决定时，智能体能做什么。「询问」会转给你审批。",
  "perm.cap.contact_agent": "联系智能体",
  "perm.cap.contact_agent.desc": "给别的智能体发消息。同工作域内按信任档位，域外需要显式授权。",
  ...
  "perm.effect.ask": "询问",
  "perm.effect.deny": "拒绝",
  "perm.tierHeading": "各信任档位的含义",
  "perm.tierIntro": "信任档位就是一组命名好的权限预设。档位越高，智能体越多事情可以不问你就做。",
  "perm.tierCol": "档位",
  "perm.inheritShort": "默认",
  "perm.tierNote": "越具体越优先：按对授权 > 单智能体覆盖 > 信任档位 > 全局默认。联系还有上方的总开关。",
  "perm.override.default": "默认",
  "perm.override.note": "标签是这个智能体当前生效的结果。覆盖只针对这一个智能体把某项能力钉死；选「默认」则跟随档位。",
