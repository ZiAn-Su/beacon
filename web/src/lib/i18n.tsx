...
const en: Dict = {
  ...
  "profile.auth": "Can message",
  "profile.noRules": "No per-pair rules. Trust tier applies.",
  "profile.pickTarget": "Choose an agent…",
...
const zh: Dict = {
  ...
  "profile.auth": "互通授权",
  "profile.noRules": "暂无单独规则，按信任档位执行。",
  "profile.pickTarget": "选择一个智能体…",
  "profile.message": "发消息",
